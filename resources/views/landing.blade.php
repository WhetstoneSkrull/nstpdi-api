...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Teacher Training Platform" />
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
              ...
              <div class="dropdown-menu-inner">
                <a href="#" class="media d-flex align-items-center">
                  ...
                  <div class="media-body ml-3">
                    <h6 class="heading text-primary mb-md-1">How it Works</h6>
                    <p class="description d-none d-md-inline-block mb-0">Learn how to integrate us into your business</p>
                  </div>
                </a>
                <a href="#" class="media d-flex align-items-center">
                  ...
                  <div class="media-body ml-3">
                    <h6 class="heading text-primary mb-md-1">FAQ</h6>
                    <p class="description d-none d-md-inline-block mb-0">We provide answers to all your questions.</p>
                  </div>
                </a>
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="https://www.facebook.com/MonieHub-107261470629969/" target="_blank" data-toggle="tooltip" title="Like us on Facebook">
          ...
          <li class="nav-item d-none d-lg-block ml-lg-4">
            <a href="https://play.google.com/store/apps/details?id=com.moniehub.app" target="_blank" class="btn btn-neutral btn-icon">
  ...
  <section class="section section-lg section-shaped pb-250">
    ...
    <div class="container py-lg-md d-flex">
      <div class="col px-0">
        <div class="row">
          <div class="col-lg-6">
            <h1 class="display-3  text-white">Teacher Training and and Learn Platform</span>
            </h1>
            <p class="lead  text-white">Prepare for you Professional Qualifying Examination (PQE) with us.
             </p>
            <div class="btn-wrapper">
              <a href="https://play.google.com/store/apps/details?id=com.moniehub.app" class="btn btn-info btn-icon mb-3 mb-sm-0">
                <span class="btn-inner--icon"><i class="fa fa-play"></i></span>
                <span class="btn-inner--text">GOOGLE PLAYSTORE</span>
              </a>
              {{-- <a href="https://www.creative-tim.com/product/argon-design-system" class="btn btn-white btn-icon mb-3 mb-sm-0">
                <span class="btn-inner--icon"><i class="ni ni-cloud-download-95"></i></span>
                <span class="btn-inner--text">APPLE STORE</span>
              </a> --}}
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h6 class="text-primary text-uppercase">Merchant (Business) Account</h6>
                <p class="description mt-3">Register and start receiving payments for free.  </p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i> 1.7% on every transaction.</p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Payments made to bank account in 24 hours.</p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Create Paypoints where customers can pay you easily.</p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i>Download all transactions in Excel format .</p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Save money on your wallet and withdraw at anytime.</p>
                  <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Earn reward coins on every completed transaction.</p>
                ...
                <a href="#" class="btn btn-primary mt-4">Join Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h6 class="text-success text-uppercase">Personal (Customer) Account</h6>
                <p class="description mt-3">Register and transact easily.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> 1.7% on every transaction.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i>Payments directly to bank account.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Save money on your wallet and withdraw at anytime.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Withdrawals can be initiated anytime.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Minimum withdrawal of &#8358;500.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> No Withdrawal  Charge.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Earn reward coins on every completed transaction.</p>
                ...
                <a href="#" class="btn btn-success mt-4">Join Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h6 class="text-warning text-uppercase">Agent Account </h6>
                <p class="description mt-3">Become an agent and earn money.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Register merchants on our platform.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Earn &#8358;1 on every &#8358;1000 worth of transaction.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> No limit on maximum amount that can be earned.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Withdrawals can be initiated anytime.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> Minimum withdrawal of &#8358;500.</p>
                <p  class="description mt-3"> <i class="ni ni-check-bold"></i> No Withdrawal  Charge.</p>
                ...
                <a href="/apply-agent" class="btn btn-warning mt-4">Apply Now</a>
              </div>
            </div>
          </div>
    ...
    <div class="row row-grid align-items-center">
      ...
      <div class="col-md-6 order-md-1">
        <div class="pr-md-5">
          ...
          <p>TTLP has been carefully built to assist prepare for your PQE successfully.</p>
          <ul class="list-unstyled mt-5">
            <li class="py-2">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <h6 class="mb-0">Enroll for training exercises.</h6>
                </div>
              </div>
            </li>
            <li class="py-2">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <h6 class="mb-0">Take practise exercises according to TRCN PQE formats.</h6>
                </div>
              </div>
            </li>
            <li class="py-2">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <h6 class="mb-0">Earn certificates after cmpleting training exercises with our Institute.</h6>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div class="col-md-6">
        <div class="card bg-default shadow border-0">
          ...
          <blockquote class="card-blockquote">
            ...
            <h4 class="display-3 font-weight-bold text-white">Robust and Flexible.</h4>
            <p class="lead text-italic text-white">MonieHub is here to solve all of your payment needs for any business you run; supermarket, shop owner, filling stations, cab driver, restaurants etc.</p>
          </blockquote>
        </div>
      </div>
      <div class="col-md-6">
        <div class="pl-md-5">
          ...
          <h3>Testimonials</h3>
          <p class="lead"> "I was hesitant at first, but it is one of the best decisions I've made in my business. Easy, quick and time saving." - Adeola Clothings.</p>
          <p>"Wow! i can create payment point easily but parents to pay school fees for their wards." - Lovelace Best Academy.</p>
          <p>"As a taxi driver, i use it to receive payments from my customers. No more worrying about change." Ayomide Daniel </p>
          <a href="#" class="font-weight-bold text-warning mt-5">Be a part of Our success story</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row row-grid align-items-center">
      ...
      <div class="col-lg-6 order-lg-1">
        <div class="d-flex px-3">
          ...
          <div class="pl-4">
            <h4 class="display-3 text-white">Wonderful Response Team</h4>
            <p class="text-white">Our representatives are always eager to answer all of your questions.</p>
          </div>
        </div>
        <div class="card shadow shadow-lg--hover mt-5">
          <div class="card-body">
            <div class="d-flex px-3">
              ...
              <div class="pl-4">
                <h5 class="title text-success">Mail Us</h5>
                <p>We ready to reply all of your messages</p>
                <a href="mailto:wearegrumie@gmail.com" class="text-success">send mail</a>
              </div>
            </div>
          </div>
        </div>
        <div class="card shadow shadow-lg--hover mt-5">
          <div class="card-body">
            <div class="d-flex px-3">
              ...
              <div class="pl-4">
                <h5 class="title text-warning">Call Us</h5>
                <p>Why not call us instead and have our representative answer you instantly.</p>
                <a href="tel:+2348089040149" class="text-warning">call now</a>
              </div>
            </div>
          </div>
        </div>
...
<section class="section section-lg bg-gradient-default">
  <div class="container pt-lg pb-300">
    <div class="row text-center justify-content-center">
      <div class="col-lg-10">
        <h2 class="display-3 text-white">Write something sweet!</h2>
        <p class="lead text-white">Tell us ways we can serve you better. We just want to grow your business.</p>
      </div>
    </div>
      ...
      <div class="col-lg-8">
        <div class="card bg-gradient-secondary shadow">
          <div class="card-body p-lg-5">
            <h4 class="mb-1">Want to work with us or have a question?</h4>
            ...
            <div class="form-group mt-5">
              ...
              <div class="input-group input-group-alternative">
                ...
                <input class="form-control" placeholder="Your name" type="text" name="full_name">
              </div>
            </div>
            ...
            <div class="form-group mb-4">
              <textarea class="form-control form-control-alternative" name="message_body" rows="4" cols="80" placeholder="Type a message..." ></textarea>
            </div>
            <div>
...
<footer class="footer has-cards">
  ...
  <div class="container">
    <div class="row row-grid align-items-center my-md">
      <div class="col-lg-6">
        <h3 class="text-primary font-weight-light mb-2">Become a part of our community</h3>
      ...
      <div class="col-lg-6 text-lg-center btn-wrapper">
        ...
        <a target="_blank" href="https://www.facebook.com/MonieHub-107261470629969/" class="btn btn-neutral btn-icon-only btn-facebook btn-round btn-lg" data-toggle="tooltip" data-original-title="Like us">
          <i class="fa fa-facebook-square"></i>
        </a>
    ...
    <div class="row align-items-center justify-content-md-between">
      <div class="col-md-6">
        <div class="copyright">
          &copy; 2020
          <a href="#" target="_blank">Niger State Teacher Professional Developement Institute (NSTPDI)</a>
        </div>
      </div>
      <div class="col-md-6">
        <ul class="nav nav-footer justify-content-end">
          <li class="nav-item">
            <a href="https://www.equily-ng.web.app" class="nav-link" target="_blank">Powered by Equily Nigeria Limited</a>
          </li>
        </ul>
      </div>
    </div>
